...
[![Profile Views](https://komarev.com/ghpvc/?username=Masterofowls&color=00D9FF&style=flat-square&label=المشاهدات)](https://github.com/Masterofowls)
[![Experience](https://img.shields.io/badge/الخبرة-4+_سنوات-00D9FF?style=flat-square&labelColor=0D1117)](#)
...
📧 [mrdaniilsht@gmail.com](mailto:mrdaniilsht@gmail.com) | 💬 [@froggytalents](https://t.me/froggytalents) | 📍 سانت بطرسبرغ
...
**مطور Fullstack** يتمتع بخبرة 4 سنوات في بناء تطبيقات الويب عالية الأداء. التخصص: **دورة التطوير الكاملة** — من تصميم واجهة المستخدم/تجربة المستخدم إلى النشر في الإنتاج. خبرة في المجموعة الحديثة (React, TypeScript, Python, Django, Docker)، إعداد خط أنابيب CI/CD، الاختبار الآلي، ونشر VPS مع اتباع أفضل ممارسات الأمان.

**🎯 الكفاءات الأساسية:**

- **Frontend:** React, TypeScript, Next.js, تصميم متجاوب، mobile-first, PWA
...
- **Testing:** اختبار API، E2E (Playwright)، اختبار آلي
- **الأمان:** HTTPS, OAuth, JWT، نشر تطبيقات آمن
...
<details open>
<summary><b>تطوير Frontend</b></summary>
...
- التصميم المتجاوب، Mobile-First، Flexbox/Grid، رسوم متحركة CSS
- Webpack, Vite bundling، تحسين حجم الحزمة
...
<details open>
<summary><b>تطوير Backend</b></summary>
...
- Node.js: Express.js, REST/GraphQL API, middleware, المصادقة
- PostgreSQL, MySQL, SQLite: تصميم قاعدة البيانات، الترحيلات، تحسين الاستعلام
- JWT, OAuth 2.0، المصادقة القائمة على الجلسة، التحكم في الوصول القائم على الدور
- WebSocket، الاتصال في الوقت الفعلي، بنية موجهة بالأحداث
- تكامل API: Telegram Bot API، Payment APIs، خدمات طرف ثالث
...
<details open>
<summary><b>DevOps والنشر</b></summary>
...
- Docker: Dockerfile, docker-compose، بناء متعدد المراحل، تحسين الصورة
- CI/CD: GitHub Actions, GitLab CI، الاختبار والنشر الآلي
- Linux (Ubuntu/Debian): إدارة VPS, SSH, systemd, cron
- Nginx: الوكيل العكسي، SSL/TLS (Let's Encrypt)، الملفات الثابتة، موازنة التحميل
- Git: استراتيجيات التفرع، merge/rebase، GitFlow، مراجعة الكود
- النشر: إعداد الإنتاج، متغيرات البيئة، التسجيل، المراقبة
...
<details>
<summary><b>الاختبار وضمان الجودة</b></summary>
...
- اختبار End-to-End: Playwright، اختبار واجهة المستخدم الآلي
- اختبار API: اختبارات REST API، Postman، التشغيل الآلي
- اختبارات الوحدة/التكامل: Jest، Pytest، تحليل التغطية
- اختبار الحمل: اختبار الأداء، المعايير
...
<details>
<summary><b>التطوير متعدد المنصات</b></summary>
...
- Electron.js: تطبيقات سطح المكتب (Windows/Mac/Linux)، IPC، الوحدات الأصلية
- React Native + Expo: تطبيقات الهاتف المحمول (iOS/Android)، التنقل، الإشعارات الفورية
- PyQt5/6: تطبيقات واجهة المستخدم الرسومية لسطح المكتب في Python
...
### 🛒 **منصة التجارة الإلكترونية** | مطور Fullstack | 2023

**Stack:** React, TypeScript, Next.js, Django REST, PostgreSQL, Docker, Nginx

- تطوير متجر إلكتروني كامل الميزات مع واجهة مستخدم متجاوبة
- تنفيذ نظام المصادقة (JWT)، عربة التسوق، تصفية المنتجات
- إعداد Django REST API مع التحكم في الوصول القائم على الدور (RBAC)، لوحة الإدارة
- النشر على VPS (Ubuntu + Nginx + SSL)، تكوين CI/CD عبر GitHub Actions
- **النتيجة:** تطبيق جاهز للإنتاج مع HTTPS آمن، نشر آلي

### 📋 **مدير المهام في الوقت الفعلي** | مطور Fullstack | 2023

**Stack:** React, FastAPI, WebSocket, PostgreSQL, Playwright

- إنشاء نظام إدارة المهام مع واجهة السحب والإفلات
- تنفيذ WebSocket للمزامنة في الوقت الفعلي بين العملاء
- كتابة اختبارات E2E (Playwright) مع تغطية أكثر من 80%
- تحسين الأداء: التحميل الكسول، مصفوفة القائمة الافتراضية
- **النتيجة:** تطبيق متجاوب يدعم 100+ مستخدم متزامن

### 🎓 **بوابة معلومات الكلية** | مطور Backend | 2022

**Stack:** Python, Django, Docker, GitLab CI/CD, Nginx, Ubuntu

- تطوير backend لنظام معلومات الكلية
- تكوين خط أنابيب CI/CD كامل (GitLab CI): الاختبارات → البناء → النشر
- أتمتة تجديد شهادة SSL (Let's Encrypt)، إعداد الوكيل العكسي
- إدارة VPS (Ubuntu)، تكوين المراقبة، التسجيل
- **النتيجة:** نظام إنتاج مستقر مع نشر آلي

### 🤖 **بوت إشعارات Telegram** | مطور Python | 2023

**Stack:** Python, aiogram 3.x, GitHub Actions, REST API

- إنشاء بوت Telegram للإشعارات الآلية وتكامل API الخارجي
- تنفيذ معالجة الأوامر، لوحات المفاتيح المضمنة، البرمجيات الوسيطة
- إعداد النشر الآلي عبر GitHub Actions
- **النتيجة:** البوت يعالج أكثر من 500 رسالة/يوم مع وقت تشغيل 99.9%

### 💻 **تطبيق سطح المكتب (Electron)** | مطور Desktop | 2023

**Stack:** Electron.js, React, TypeScript, SQLite

- تطوير تطبيق سطح مكتب متعدد المنصات (Windows/Mac/Linux)
- تنفيذ اتصال IPC، عمليات نظام الملفات، قاعدة البيانات المحلية
- إنشاء وظيفة التحديث التلقائي، مثبتات التطبيق
- **النتيجة:** تطبيق مع أكثر من 200 مستخدم نشط

---

## 🎓 التعليم

| 🏫 المؤسسة                | 📚 التخصص          | 📅 الفترة   |
| ------------------------- | ------------------ | ----------- |
| **IT College Hexlet**     | تطوير الويب        | 2023 - 2026 |
| **Computer Academy STEP** | اختبار ضمان الجودة | 2021 - 2022 |
...
**البحث عن:** منصب مطور Fullstack مستوى Junior/Mid  
**الموقع:** سانت بطرسبرغ، روسيا  
**التنسيق:** عن بُعد / مختلط

**نقاط القوة الرئيسية:**

- 🎨 التصميم المتجاوب والتخطيطات التكيفية لجميع الأجهزة
- ⚡ دورة التطوير الكاملة: من التصميم إلى النشر في الإنتاج
- 🔧 أتمتة CI/CD، الحاويات Docker، إدارة VPS
- 🔒 النشر مع أفضل ممارسات الأمان (HTTPS، SSL/TLS)
- 🧪 الاختبار الآلي (E2E، اختبار API)
- 🤝 التعاون الجماعي، مراجعة الكود، سير عمل Git
...
[![Email](https://img.shields.io/badge/البريد_الإلكتروني-mrdaniilsht%40gmail.com-00D9FF?style=flat-square&logo=gmail&logoColor=white&labelColor=0D1117)](mailto:mrdaniilsht@gmail.com)
...
[![Portfolio](https://img.shields.io/badge/السيرة_الذاتية-CV_الكامل-00D9FF?style=flat-square&logo=readme&logoColor=white&labelColor=0D1117)](https://any.coop/A94vJzyywVay5hRKuq1YHVSEEqsxxkdR2jdYo6R3ytJ1qtfn/resume)
...
<sub>⚡ مطور Fullstack | خبرة 4 سنوات | حلول جاهزة للإنتاج</sub>
