...
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&size=30&duration=2500&pause=800&color=00D9FF&center=true&vCenter=true&width=850&lines=Daniil+Shtarkman;Desarrollador+Fullstack;Python+%7C+JavaScript+%7C+TypeScript;React+%7C+Django+%7C+FastAPI+%7C+Electron;Docker+%7C+CI%2FCD+%7C+Testing+%7C+Deployment" alt="Typing SVG" />
...
[![Profile Views](https://komarev.com/ghpvc/?username=Masterofowls&color=00D9FF&style=flat-square&label=Vistas)](https://github.com/Masterofowls)
[![Experience](https://img.shields.io/badge/Experiencia-4+_Años-00D9FF?style=flat-square&labelColor=0D1117)](#)
...
📧 [mrdaniilsht@gmail.com](mailto:mrdaniilsht@gmail.com) | 💬 [@froggytalents](https://t.me/froggytalents) | 📍 San Petersburgo
...
**Desarrollador Fullstack** con 4 años de experiencia en la creación de aplicaciones web de alto rendimiento. Especialización: **ciclo completo de desarrollo** — desde diseño UI/UX hasta despliegue en producción. Experiencia con stack moderno (React, TypeScript, Python, Django, Docker), configuración de pipelines CI/CD, pruebas automatizadas y despliegue en VPS siguiendo las mejores prácticas de seguridad.

**🎯 Competencias Clave:**

- **Frontend:** React, TypeScript, Next.js, diseño responsive, mobile-first, PWA
...
- **Testing:** Pruebas API, E2E (Playwright), pruebas automatizadas
- **Seguridad:** HTTPS, OAuth, JWT, despliegue seguro de aplicaciones
...
- ES6+, async/await, Promises, tipado TypeScript
- React Hooks, Context API, Redux, hooks personalizados
- Next.js: SSR/SSG, App Router, API Routes, Middleware
- Diseño responsive, Mobile-First, Flexbox/Grid, animaciones CSS
- Webpack, Vite bundling, optimización del tamaño del bundle
...
- Node.js: Express.js, REST/GraphQL API, middleware, autenticación
- PostgreSQL, MySQL, SQLite: diseño de bases de datos, migraciones, optimización de consultas
- JWT, OAuth 2.0, autenticación basada en sesiones, control de acceso basado en roles
- WebSocket, comunicación en tiempo real, arquitectura orientada a eventos
- Integración API: Telegram Bot API, APIs de pago, servicios de terceros
...
<details open>
<summary><b>DevOps y Despliegue</b></summary>
...
- Docker: Dockerfile, docker-compose, builds multi-etapa, optimización de imágenes
- CI/CD: GitHub Actions, GitLab CI, pruebas y despliegue automatizados
- Linux (Ubuntu/Debian): administración VPS, SSH, systemd, cron
- Nginx: proxy inverso, SSL/TLS (Let's Encrypt), archivos estáticos, balanceo de carga
- Git: estrategias de ramificación, merge/rebase, GitFlow, revisión de código
- Despliegue: configuración de producción, variables de entorno, logging, monitoreo
...
<details>
<summary><b>Testing y QA</b></summary>
...
- Pruebas End-to-End: Playwright, pruebas UI automatizadas
- Pruebas API: pruebas REST API, Postman, automatización
- Pruebas unitarias/de integración: Jest, Pytest, análisis de cobertura
- Pruebas de carga: pruebas de rendimiento, benchmarks
...
<details>
<summary><b>Desarrollo Multiplataforma</b></summary>
...
- Electron.js: aplicaciones de escritorio (Windows/Mac/Linux), IPC, módulos nativos
- React Native + Expo: aplicaciones móviles (iOS/Android), navegación, notificaciones push
- PyQt5/6: aplicaciones GUI de escritorio en Python
...
### 🛒 **Plataforma de E-Commerce** | Desarrollador Fullstack | 2023

**Stack:** React, TypeScript, Next.js, Django REST, PostgreSQL, Docker, Nginx

- Desarrollé tienda en línea completa con UI responsive
- Implementé sistema de autenticación (JWT), carrito de compras, filtrado de productos
- Configuré API Django REST con control de acceso basado en roles (RBAC), panel de administración
- Desplegué en VPS (Ubuntu + Nginx + SSL), configuré CI/CD vía GitHub Actions
- **Resultado:** aplicación lista para producción con HTTPS seguro, despliegue automatizado

### 📋 **Gestor de Tareas en Tiempo Real** | Desarrollador Fullstack | 2023

**Stack:** React, FastAPI, WebSocket, PostgreSQL, Playwright

- Creé sistema de gestión de tareas con interfaz drag-and-drop
- Implementé WebSocket para sincronización en tiempo real entre clientes
- Escribí pruebas E2E (Playwright) con cobertura del 80%+
- Optimicé rendimiento: lazy loading, virtualización de listas
- **Resultado:** aplicación responsive soportando 100+ usuarios concurrentes

### 🎓 **Portal de Información Universitaria** | Desarrollador Backend | 2022

**Stack:** Python, Django, Docker, GitLab CI/CD, Nginx, Ubuntu

- Desarrollé backend para sistema de información universitaria
- Configuré pipeline CI/CD completo (GitLab CI): pruebas → build → deploy
- Automaticé renovación de certificados SSL (Let's Encrypt), configuré proxy inverso
- Administré VPS (Ubuntu), configuré monitoreo, logging
- **Resultado:** sistema de producción estable con despliegue automatizado

### 🤖 **Bot de Notificaciones Telegram** | Desarrollador Python | 2023

**Stack:** Python, aiogram 3.x, GitHub Actions, REST API

- Creé bot de Telegram para notificaciones automatizadas e integración con API externa
- Implementé manejo de comandos, teclados inline, middleware
- Configuré despliegue automatizado vía GitHub Actions
- **Resultado:** bot procesa 500+ mensajes/día con 99,9% de uptime

### 💻 **Aplicación de Escritorio (Electron)** | Desarrollador Desktop | 2023

**Stack:** Electron.js, React, TypeScript, SQLite

- Desarrollé aplicación de escritorio multiplataforma (Windows/Mac/Linux)
- Implementé comunicación IPC, operaciones del sistema de archivos, base de datos local
- Creé funcionalidad de auto-actualización, instaladores de aplicación
- **Resultado:** aplicación con 200+ usuarios activos

---

## 🎓 Educación

| 🏫 Institución            | 📚 Especialización | 📅 Período  |
| ------------------------- | ------------------ | ----------- |
| **IT College Hexlet**     | Desarrollo Web     | 2023 - 2026 |
| **Computer Academy STEP** | Testing QA         | 2021 - 2022 |
...
![GitHub Stats](assets/metrics/metrics.svg)
...
**Buscando:** Posición de Desarrollador Fullstack Junior/Mid-level  
**Ubicación:** San Petersburgo, Rusia  
**Formato:** Remoto / Híbrido

**Fortalezas clave:**

- 🎨 Diseño responsive y layouts adaptativos para todos los dispositivos
- ⚡ Ciclo completo de desarrollo: desde diseño hasta despliegue en producción
- 🔧 Automatización CI/CD, contenedorización Docker, administración VPS
- 🔒 Despliegue con mejores prácticas de seguridad (HTTPS, SSL/TLS)
- 🧪 Pruebas automatizadas (E2E, pruebas API)
- 🤝 Colaboración en equipo, revisión de código, flujo de trabajo Git
...
[![Portfolio](https://img.shields.io/badge/Currículum-CV_Completo-00D9FF?style=flat-square&logo=readme&logoColor=white&labelColor=0D1117)](https://any.coop/A94vJzyywVay5hRKuq1YHVSEEqsxxkdR2jdYo6R3ytJ1qtfn/resume)
...
<sub>⚡ Desarrollador Fullstack | 4 años de experiencia | Soluciones listas para producción</sub>
