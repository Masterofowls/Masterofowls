...
[![Profile Views](https://komarev.com/ghpvc/?username=Masterofowls&color=00D9FF&style=flat-square&label=दृश्य)](https://github.com/Masterofowls)
[![Experience](https://img.shields.io/badge/अनुभव-4+_वर्ष-00D9FF?style=flat-square&labelColor=0D1117)](#)
...
📧 [mrdaniilsht@gmail.com](mailto:mrdaniilsht@gmail.com) | 💬 [@froggytalents](https://t.me/froggytalents) | 📍 सेंट पीटर्सबर्ग
...
4 साल के अनुभव के साथ **Fullstack Developer** उच्च-प्रदर्शन वेब एप्लिकेशन बनाने में। विशेषज्ञता: **पूर्ण विकास चक्र** — UI/UX डिज़ाइन से उत्पादन परिनियोजन तक। आधुनिक stack (React, TypeScript, Python, Django, Docker), CI/CD पाइपलाइन सेटअप, स्वचालित परीक्षण, और सुरक्षा सर्वोत्तम प्रथाओं के साथ VPS परिनियोजन में अनुभवी।

**🎯 मुख्य दक्षताएं:**

- **Frontend:** React, TypeScript, Next.js, उत्तरदायी डिज़ाइन, mobile-first, PWA
...
- **Testing:** API परीक्षण, E2E (Playwright), स्वचालित परीक्षण
- **सुरक्षा:** HTTPS, OAuth, JWT, सुरक्षित एप्लिकेशन परिनियोजन
...
<details open>
<summary><b>Frontend विकास</b></summary>
...
- उत्तरदायी डिज़ाइन, Mobile-First, Flexbox/Grid, CSS एनिमेशन
- Webpack, Vite bundling, bundle आकार अनुकूलन
...
<details open>
<summary><b>Backend विकास</b></summary>
...
- Node.js: Express.js, REST/GraphQL API, middleware, प्रमाणीकरण
- PostgreSQL, MySQL, SQLite: डेटाबेस डिज़ाइन, माइग्रेशन, क्वेरी अनुकूलन
- JWT, OAuth 2.0, सत्र-आधारित प्रमाणीकरण, भूमिका-आधारित पहुंच नियंत्रण
- WebSocket, वास्तविक समय संचार, घटना-संचालित वास्तुकला
- API एकीकरण: Telegram Bot API, Payment APIs, तृतीय-पक्ष सेवाएं
...
<details open>
<summary><b>DevOps और परिनियोजन</b></summary>
...
- Docker: Dockerfile, docker-compose, मल्टी-स्टेज builds, छवि अनुकूलन
- CI/CD: GitHub Actions, GitLab CI, स्वचालित परीक्षण और परिनियोजन
- Linux (Ubuntu/Debian): VPS प्रशासन, SSH, systemd, cron
- Nginx: रिवर्स प्रॉक्सी, SSL/TLS (Let's Encrypt), स्थिर फ़ाइलें, लोड बैलेंसिंग
- Git: शाखाकरण रणनीतियाँ, merge/rebase, GitFlow, कोड समीक्षा
- परिनियोजन: उत्पादन सेटअप, पर्यावरण चर, लॉगिंग, निगरानी
...
<details>
<summary><b>परीक्षण और QA</b></summary>
...
- End-to-End परीक्षण: Playwright, स्वचालित UI परीक्षण
- API परीक्षण: REST API परीक्षण, Postman, स्वचालन
- यूनिट/एकीकरण परीक्षण: Jest, Pytest, कवरेज विश्लेषण
- लोड परीक्षण: प्रदर्शन परीक्षण, बेंचमार्क
...
<details>
<summary><b>क्रॉस-प्लेटफ़ॉर्म विकास</b></summary>
...
- Electron.js: डेस्कटॉप एप्लिकेशन (Windows/Mac/Linux), IPC, मूल मॉड्यूल
- React Native + Expo: मोबाइल एप्लिकेशन (iOS/Android), नेविगेशन, पुश नोटिफिकेशन
- PyQt5/6: Python में डेस्कटॉप GUI एप्लिकेशन
...
## 💼 कार्य अनुभव और परियोजनाएं

### 🛒 **ई-कॉमर्स प्लेटफॉर्म** | Fullstack Developer | 2023

**Stack:** React, TypeScript, Next.js, Django REST, PostgreSQL, Docker, Nginx

- उत्तरदायी UI के साथ पूर्ण-विशेषताओं वाला ऑनलाइन स्टोर विकसित किया
- प्रमाणीकरण प्रणाली (JWT), शॉपिंग कार्ट, उत्पाद फ़िल्टरिंग लागू की
- भूमिका-आधारित पहुंच नियंत्रण (RBAC), व्यवस्थापक पैनल के साथ Django REST API सेट किया
- VPS (Ubuntu + Nginx + SSL) पर परिनियोजित, GitHub Actions के माध्यम से CI/CD कॉन्फ़िगर किया
- **परिणाम:** सुरक्षित HTTPS, स्वचालित परिनियोजन के साथ उत्पादन-तैयार एप्लिकेशन

### 📋 **रीयल-टाइम टास्क मैनेजर** | Fullstack Developer | 2023

**Stack:** React, FastAPI, WebSocket, PostgreSQL, Playwright

- ड्रैग-एंड-ड्रॉप इंटरफ़ेस के साथ कार्य प्रबंधन प्रणाली बनाई
- क्लाइंट के बीच वास्तविक समय समकालन के लिए WebSocket लागू किया
- 80%+ कवरेज के साथ E2E परीक्षण (Playwright) लिखे
- प्रदर्शन अनुकूलित: lazy loading, सूची वर्चुअलाइज़ेशन
- **परिणाम:** 100+ समवर्ती उपयोगकर्ताओं का समर्थन करने वाला उत्तरदायी एप्लिकेशन

### 🎓 **कॉलेज सूचना पोर्टल** | Backend Developer | 2022

**Stack:** Python, Django, Docker, GitLab CI/CD, Nginx, Ubuntu

- कॉलेज सूचना प्रणाली के लिए बैकएंड विकसित किया
- पूर्ण CI/CD पाइपलाइन कॉन्फ़िगर किया (GitLab CI): परीक्षण → निर्माण → परिनियोजन
- स्वचालित SSL प्रमाणपत्र नवीनीकरण (Let's Encrypt), रिवर्स प्रॉक्सी सेट किया
- VPS (Ubuntu) प्रशासित, निगरानी, लॉगिंग कॉन्फ़िगर किया
- **परिणाम:** स्वचालित परिनियोजन के साथ स्थिर उत्पादन प्रणाली

### 🤖 **टेलीग्राम सूचना बॉट** | Python Developer | 2023

**Stack:** Python, aiogram 3.x, GitHub Actions, REST API

- स्वचालित सूचनाओं और बाहरी API एकीकरण के लिए टेलीग्राम बॉट बनाया
- कमांड हैंडलिंग, इनलाइन कीबोर्ड, मिडलवेयर लागू किया
- GitHub Actions के माध्यम से स्वचालित परिनियोजन सेट किया
- **परिणाम:** बॉट 500+ संदेश/दिन संसाधित करता है 99.9% अपटाइम के साथ

### 💻 **डेस्कटॉप ऐप (Electron)** | Desktop Developer | 2023

**Stack:** Electron.js, React, TypeScript, SQLite

- क्रॉस-प्लेटफ़ॉर्म डेस्कटॉप एप्लिकेशन विकसित किया (Windows/Mac/Linux)
- IPC संचार, फ़ाइल सिस्टम संचालन, स्थानीय डेटाबेस लागू किया
- ऑटो-अपडेट कार्यक्षमता, एप्लिकेशन इंस्टॉलर बनाए
- **परिणाम:** 200+ सक्रिय उपयोगकर्ताओं वाला एप्लिकेशन

---

## 🎓 शिक्षा

| 🏫 संस्थान                | 📚 विशेषज्ञता | 📅 अवधि     |
| ------------------------- | ------------- | ----------- |
| **IT College Hexlet**     | वेब विकास     | 2023 - 2026 |
| **Computer Academy STEP** | QA परीक्षण    | 2021 - 2022 |
...
**खोज रहे हैं:** Junior/Mid-level Fullstack Developer पद  
**स्थान:** सेंट पीटर्सबर्ग, रूस  
**प्रारूप:** दूरस्थ / हाइब्रिड

**मुख्य शक्तियाँ:**

- 🎨 सभी उपकरणों के लिए उत्तरदायी डिज़ाइन और अनुकूली लेआउट
- ⚡ पूर्ण विकास चक्र: डिज़ाइन से उत्पादन परिनियोजन तक
- 🔧 CI/CD स्वचालन, Docker कंटेनराइज़ेशन, VPS प्रशासन
- 🔒 सुरक्षा सर्वोत्तम प्रथाओं (HTTPS, SSL/TLS) के साथ परिनियोजन
- 🧪 स्वचालित परीक्षण (E2E, API परीक्षण)
- 🤝 टीम सहयोग, कोड समीक्षा, Git वर्कफ़्लो
...
[![Email](https://img.shields.io/badge/ईमेल-mrdaniilsht%40gmail.com-00D9FF?style=flat-square&logo=gmail&logoColor=white&labelColor=0D1117)](mailto:mrdaniilsht@gmail.com)
...
[![Portfolio](https://img.shields.io/badge/रिज्यूमे-पूर्ण_CV-00D9FF?style=flat-square&logo=readme&logoColor=white&labelColor=0D1117)](https://any.coop/A94vJzyywVay5hRKuq1YHVSEEqsxxkdR2jdYo6R3ytJ1qtfn/resume)
...
<sub>⚡ Fullstack Developer | 4 साल का अनुभव | उत्पादन-तैयार समाधान</sub>
